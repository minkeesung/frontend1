...
class ProjectShow extends React.Component {
  ...
  renderEditDeleteButtons() {
    if (this.props.user && this.props.project.creator_id === this.props.user.id) {
      return (
        <div>
          <Link to={`/projects/${this.projectId}/edit`}><button>Edit this project</button></Link>
          ...
          <div className="project-show-header">
            <div className="show-title-author">
              <div className="show-creator-info">
                <img src={this.props.project.creator_image_url} alt="creator_image"/>
                <div>
                  <p>By</p>&nbsp;
            ...
            <div className="show-image-stats">
              <img src={this.props.project.image_url} alt="image_url"/>
